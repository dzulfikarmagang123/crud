	...
	public function ambildata()
	{
		if ($this->input->is_ajax_request() == true) {
			...
			foreach ($list as $field) {
				...
				// Membuat Tombol
				$tomboledit = "<button type=\"button\" class=\"btn btn-dark\" title=\"Edit Data\" onclick=\"edit('" . $field->nobp . "')\">
                    <i class=\"fa fa-edit\"></i>
                </button>";
				$tombolhapus = "<button type=\"button\" class=\"btn btn-danger\" title=\"Hapus Data\" onclick=\"hapus('" . $field->nobp . "')\">
